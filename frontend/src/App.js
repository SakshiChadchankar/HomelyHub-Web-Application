...
function App() {
  const stripePromise =loadStripe(
    "pk_test_51Osi4RSHVDcDFgpV5jiJAawWn156YH8hiHOp7qYiYo6c9aCX4uS1hzzvKjwb5guLsgabh1Pw0xVPaIwpY2DYLCri000rZfEAjZ"
    );
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" element={<Main />} id="main" exact>
        ...
        />
        <Route id="mybookings" path="user/booking"
          element={<MyBookings/>}
        />
  ...
  return (
    <div className="App">
      {/* this ensure that routing functionality is available throught the application */}
